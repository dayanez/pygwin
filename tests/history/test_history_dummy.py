...
def test_is_ignore(xession):
    xession.env["PYGWIN_HISTORY_BACKEND"] = "dummy"
    xession.env["PYGWIN_HISTORY_IGNORE_REGEX"] = "(ls|cat)"
    history = construct_history()
