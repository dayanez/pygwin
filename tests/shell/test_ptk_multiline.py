...
from pygwin.tools import ON_WINDOWS
...
def ctx(xession):
    ...
    xession.env["INDENT"] = "    "
    from pygwin.shells.ptk_shell.key_bindings import carriage_return
...
def test_nodedent(ctx):
    ...
    with patch("pygwin.shells.ptk_shell.key_bindings.can_compile", mock):
