...
from pygwin.webconfig import main as web_main
from pygwin.xonfig import xonfig_main
...
class MockRequest:
    ...
    def _request(self):
        web_main.PygwinConfigHTTPRequestHandler(self, (0, 0), None)
        return self
...
class TestXonfigWeb:
    ...
    def test_it_rewrites_correctly(self, request_factory, rc_file):
        rc_file.write_text(
            """
pre-lines
# PYGWIN WEBCONFIG START
$PYGWIN_COLOR_STYLE = 'abap'
# PYGWIN WEBCONFIG END
post
lines
"""
        )
