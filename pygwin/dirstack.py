"""Directory stack and associated utilities for the pygwin shell.
...
def _try_cdpath(apath):
    ...
    # CDPATH=$HOME/src (with src/pygwin/ inside)
    # $ cd pygwin -> src/pygwin (with pygwin/pygwin)
    # a second $ cd pygwin has no effects, to move in the nested pygwin
    # in bash a full $ cd ./pygwin is needed.
    # In pygwin a relative folder is always preferred.
    env = XSH.env
