"""Implements the pygwin parser for Python v3.8."""

import pygwin.parsers.ast as ast
from pygwin.parsers.base import store_ctx
from pygwin.parsers.v36 import Parser as ThreeSixParser


class Parser(ThreeSixParser):
    """A Python v3.8 compliant parser for the pygwin language."""
