"""Tokenization help for pygwin programs.
...
It is modified to properly tokenize pygwin code, including backtick regex
path and several pygwin-specific operators.
...
_glbs = globals()
for v in _pygwin_tokens.values():
    _glbs[v] = N_TOKENS
    tok_name[N_TOKENS] = v
    N_TOKENS += 1  # type: ignore
    __all__.append(v)
...
EXACT_TOKEN_TYPES.update(_pygwin_tokens)
    ...
    while True:  # loop over lines in stream
        ...
        while pos < max:
            ...
            if pseudomatch:  # scan for tokens
                ...
                # Pygwin-specific Regex Globbing
