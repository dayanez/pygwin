...
def get_tokens(s, tolerant, pymode=True, tokenize_ioredirects=True, is_subproc=False):
    """
    Given a string containing pygwin code, generates a stream of relevant PLY
...
class Lexer:
    """Implements a lexer for the pygwin language."""
