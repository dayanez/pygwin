"""Command-line interface for ``pygwin format``.

The dispatcher in :mod:`pygwin.main` peeks at ``sys.argv`` and, if the
...
from pygwin.formatter.core import FormatError, format_source
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog=_PROG,
        description="Format pygwin source files in place.",
    )
    p.add_argument(
        "files",
        nargs="+",
