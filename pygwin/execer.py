"""Implements the pygwin executer."""
...
class Execer:
    """Executes pygwin code in a context."""

    def __init__(
        self,
        filename="<pygwin-code>",
        debug_level=0,
        parser_args=None,
        scriptcache=True,
        cacheall=False,
        ...
        cacheall : bool, optional
            Whether or not to cache all pygwin code, and not just files. If this
    ...
    def parse(
        ...
        """Parses pygwin code in a context-aware fashion. For context-free
        ...
        # against $PYGWIN_SUBPROC_RAISE_ERROR.
    ...
    def compile(
        ...
        """Compiles pygwin code into a Python code object, which may then
        be execed or evaled.
        """
        if filename is None:
            filename = self.filename
    ...
    def eval(
        ...
        """Evaluates (and returns) pygwin code."""
        if glbs is None:
            glbs = {}
