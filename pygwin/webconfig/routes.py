...
from . import pygwin_data
from . import tags as t
from .file_writes import insert_into_pygwinrc
...
class Routes:
    ...
    def err(self, msg: str):
        html = pygwin_data.rst_to_html(msg)
    ...
    _external_links = [
        ...
        ("Code", "https://github.com/dayanez/pygwin"),
    ]
...
class ColorsPage(Routes):
    ...
    def __init__(self, **kwargs):
        ...
        self.colors = dict(pygwin_data.render_colors())
        self.var_name = "PYGWIN_COLOR_STYLE"
...
class PromptsPage(Routes):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        prompts = pygwin_data.render_prompts(self.env)
...
class EnvVariablesPage(Routes):
    ...
    def get_rows(self):
        for name in sorted(self.env.keys()):
            ...
            html = pygwin_data.rst_to_html(envvar.doc)
            yield t.tr()[
