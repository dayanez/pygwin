...
Examples
 please see :py:class:`pygwin.completers.completer.CompleterAlias` class
"""
...
class ArgParserAlias:
    ...
    Examples
    ---------
        For usage please check :py:mod:`pygwin.completers.completer`
    """
    ...
    def pygwin_complete(self, command, **kwargs):
