...
from pygwin.cli_utils import Annotated, Arg, NumpyDoc
from pygwin.completers.tools import RichCompletion, is_exclusive_completer, justify
...
def remove_completer(
    ...
    """Removes a completer from pygwin
