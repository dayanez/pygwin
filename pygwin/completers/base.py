"""Base completer for pygwin."""

import collections.abc as cabc

from pygwin.completers.commands import complete_command
from pygwin.completers.path import contextual_complete_path
from pygwin.completers.python import complete_python
from pygwin.completers.tools import apply_lprefix, contextual_completer, tag_provider
