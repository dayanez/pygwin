...
This version of uname was written in Python for the pygwin project: http://xon.sh
...
def uname_fn(
    ...
    """This version of uname was written in Python for the pygwin project: https://xon.sh
...
def main(args=None):
    from pygwin.xoreutils.util import run_alias
