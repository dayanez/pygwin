"""Tools for diff'ing two pygwin history files in a meaningful fashion."""

import datetime
import difflib
import itertools

from pygwin.color_tools import COLORS
...
class HistoryDiffer:
    """This class helps diff two pygwin history files."""
