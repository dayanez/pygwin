...
from pygwin.tools import print_exception
...
class PromptToolkitCompleter(Completer):
    ...
    It just redirects requests to normal Pygwin completer.
    """

    def __init__(self, completer, ctx, shell):
        """Takes instance of pygwin.completer.Completer, the pygwin execution
    ...
    def get_completions(self, document, complete_event):
        ...
        sug_comp = None
        if env.get("PYGWIN_PROMPT_AUTO_SUGGEST") and env.get(
