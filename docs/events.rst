Built-in Events
===============
The following events are defined by pygwin itself. For more information about events,
...
in pygwin, the command will have started running, but won't necessarily have
...
way process pipelines and specs work in pygwin, the command will have
