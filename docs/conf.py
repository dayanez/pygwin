...
os.environ["PYGWIN_NO_AMALGAMATE"] = "1"
...
from pygwin.environ import Env, Var, Xettings

if tp.TYPE_CHECKING:
    pass
import pygwin.main as xmain
...
if spec is not None:
    ...
    from pygwin.shells.ptk_shell import events
else:
...
redirects = {
    ...
    "tutorial_pygwin_projects": "pygwin_projects.html",
    "tutorial_pgtrib": "pgtrib.html",
    "xontrib": "pgtrib.html",
...
project = "pygwin"
copyright = 'Pygwin Contributors / https://github.com/xonsh/xonsh/graphs/contributors?all=1'
...
version = PYGWIN_VERSION.rsplit(".", 1)[0]

# The full version, including alpha/beta/rc tags.
release = PYGWIN_VERSION
...
# Drives the Furo sidebar brand text — capitalize "Pygwin" and "Documentation"
# to match the project's documentation-style guidelines.
html_title = f"Pygwin {release} Documentation"
...
# of the sidebar.
html_logo = "_static/pygwin_terminal_icon_256.png"
...
latex_documents = [
    ("index", "pygwin.tex", "pygwin documentation", "Pygwin Contributors", "manual")
]
...
def setup(app: Sphinx):
    from pygwin.pyghooks import PygwinConsoleLexer, PygwinLexer
    ...
    PygwinLexer.docs_mode = True
    PygwinConsoleLexer.docs_mode = True

    app.add_lexer("pygwincon", PygwinConsoleLexer)
    app.add_css_file("custom.css")

# To avoid having red highlighting in python/pygwincon blocks.
suppress_warnings = [
    #"misc.highlighting_failure",  # pygwin $VAR syntax in code blocks
